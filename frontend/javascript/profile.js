            ...
            .then(function (results) {
                ...
                try {
                    ...
                    for (let i = 0; i < results.length; i++) {
                        ...
                        // alert(JSON.stringify());
                        $strm += "<div class=\"token-card \" \"> <div> <img src=\"" + $img + "\" alt=\" \" class=\" token-owner-logo \" align=\"left \"> </div>" + $menu_ic + "<p></p> <img src=\"" + $img + "\" class=\"collectible-img-top \" alt=\"... \"> <p></p> <div class=\"token-card-body \"> <h5 class=\"collectible-title \">" + obj1.get("licensingName") + "</h5> <P class=\"collectible-card-cost \"><b>$" + obj1.get("licensingCost") + "</b></P> <button type=\"button \" class=\"btn btn-danger btn-lg \">BUY</button> </div></div>";
                    }
