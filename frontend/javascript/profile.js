            ...
            .then(function (results) {
                ...
                try {
                    ...
                    for (let i = 0; i < results.length; i++) {
                        ...
                        $strm += "<div class=\"token-card \" \"> <div></div> " + "<img src=\"" + obj1.get("activityFile").url() + "\" class=\"token-img-top \" > <p></p> <div class=\"token-card-body \"> <h5 class=\"token-title \">" + obj1.get("activityName") + "</h5> <P class=\"token-card-cost \"><b>$" + obj1.get("activityCost") + " one time fee</b></P> <p class=\"token-card-text \"> " + obj1.get("activityDesc") + " </p> <a href=\"connectProduct.html?userId=" + $username + "&objId=" + obj1.id + "\"><button type=\"button \" class=\"btn btn-danger btn-lg \">JOIN</button></a> </div> </div>";
                        // alert(JSON.stringify());
                    }
